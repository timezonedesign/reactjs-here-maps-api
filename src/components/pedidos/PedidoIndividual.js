...
class PedidoIndividual extends Component {
  ...
  mostrarDireccion = () => {
      ...
      return (
        <div>
          <input disabled value={this.props.location.state.Adress.Adress + " " + this.props.location.state.Adress.Floor + " " + this.props.location.state.Adress.Department} type="text" className="form-control" required/>
        </div>
      );
